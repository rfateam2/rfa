...
'''
from rfaUtils import getLog, qaPrint, dropFile, getTridFullPath, getLocalEnv, getTestCases
import os
import sys

#declaration section
lister = 'tcid|rest_URL|HTTP_method|HTTP_RC_desired|param_list'#just form Spec
